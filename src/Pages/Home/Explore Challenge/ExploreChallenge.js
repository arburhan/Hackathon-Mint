...
const ExploreChallenge = () => {
    ...
    return (
        <section className='' >
                    ...
                    <div className=''>
                        {dropdown === false ?
                            <div
                                ...
                                className='flex duration-100   absolute bg-white p-2 rounded-md text-black cursor-pointer' >
                            ...
                            :
                            <div
                                className='duration-100  w-[290px] bg-white pl-4 pt-6 pb-3 rounded-md text-black absolute z-10 shadow-2xl' >
                                <div
                                    onClick={() => {
                                        setDropdown(false)
                                    }}
                                ...
                                <hr className='px-2 text-[#ECECEC] w-[265.01px]' />
                                <div className='py-4' >
                                    <fieldset>
            ...
            {/* challenges */}
            <div className='grid grid-cols-3 justify-items-center gap-y-14 pt-20 pb-32 bg-[#003145]' >
                {
